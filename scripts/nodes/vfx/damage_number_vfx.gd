...
const SCENE: PackedScene = preload("res://scenes/vfx/damage_number_vfx.tscn")

var _text: String

@onready var label: Label = %Label

static func create(target: Creature, damage: int) -> DamageNumberVfx:
	var vfx: DamageNumberVfx = SCENE.instantiate()
	vfx._text = str(damage)
